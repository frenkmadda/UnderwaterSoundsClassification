...
if __name__ == "__main__":
    ...
    path_model = 'models/testMulti_google_net'
    batch_size = 32
    num_epochs = 50
    patience = 5
    learning_rate = 0.001
    ...
    # Inizializzazione del modello AlexNet pre-addestrato
    model = models.alexnet(weights=AlexNet_Weights.IMAGENET1K_V1)
    num_ftrs = model.classifier[6].in_features
    model.classifier[6] = nn.Linear(num_ftrs, num_classes)  # 38 classi
    ...
    metrics_df.to_csv('results/multi_google_net_training_metrics.csv', index=False)
